...
import { Download, Briefcase, GraduationCap as School, Trophy, Code as Code2 } from '@phosphor-icons/react';
        ...
        <main className="w-full flex flex-col gap-12">
          ...
          {/* Intro Section */}
            <motion.section 
              ...
              className="border-3 border-neo-border bg-white p-6 md:p-10 shadow-neo relative overflow-hidden" 
              id="intro"
            >
              ...
              <div className="relative z-10 flex flex-col gap-6">
                <div>
                  <motion.div variants={itemVariants} className="inline-block px-3 py-1 bg-[var(--neo-text)] text-white font-mono text-xs mb-4 uppercase tracking-widest">Full Stack Engineer</motion.div>
                  <motion.h1 variants={itemVariants} className="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-[0.9] mb-4">
                    {RESUME_DATA.name.split(' ')[0]}<br />{RESUME_DATA.name.split(' ')[1]}
                  </motion.h1>
                  <motion.p variants={itemVariants} className="text-xl max-w-2xl text-gray-500 leading-relaxed border-l-4 border-primary pl-4">
                    {RESUME_DATA.summary}
                  </motion.p>
                </div>
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div variants={itemVariants} className="border-3 border-neo-border bg-white shadow-neo group hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] transition-all">
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-6">
                {education.map((edu) => (
                  <motion.div variants={itemVariants} key={edu.institution} className="neo-brutal-box flex flex-col md:flex-row bg-white relative group overflow-hidden">
